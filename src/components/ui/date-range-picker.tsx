...
const dateRangePickerStyles = tv({
  slots: {
    ...
    dateRangePickerInputStart: "px-2 text-base uppercase tabular-nums lg:text-sm",
    dateRangePickerInputEnd: "flex-1 px-2 py-1.5 text-base uppercase tabular-nums lg:text-sm",
    dateRangePickerDash:
