...
const selectTriggerStyles = tv({
  extend: focusStyles,
  base: [
    "btr flex h-10 w-full cursor-default items-center gap-4 rounded-lg border border-input bg-bg py-2 pl-3 pr-2 text-start shadow-[inset_0_1px_0_0_rgba(255,255,255,0.1)] transition group-open:border-primary group-open:ring-4 group-open:ring-primary/20 focus-visible:border-primary focus-visible:ring-4 focus-visible:ring-primary/20 group-disabled:bg-secondary group-disabled:opacity-50 dark:shadow-none [&_[data-slot=icon]]:size-4"
  ],
  variants: {
    isDisabled: {
      false:
