...
const cellStyles = tv({
  extend: focusRing,
  base: "flex size-10 cursor-default items-center justify-center rounded-full tabular-nums forced-color-adjust-none sm:size-9 lg:text-sm",
  variants: {
    isSelected: {
...
const calendarHeaderStyles = tv({
  slots: {
    ...
    heading: "mr-2 flex-1 text-left font-medium tracking-tight text-muted-fg",
    calendarGridHeaderCell: "text-sm font-semibold text-muted-fg lg:text-xs"
  }
})
  ...
  return (
    <header className={header({ className })} {...props}>
      ...
      <div className="flex items-center gap-1">
        <Button
          size="square-petite"
          className="size-8 sm:size-7 [&_[data-slot=icon]]:text-fg"
          shape="circle"
          appearance="plain"
          slot="previous"
        >
